...
<div class="pagetitle">
    ...
    <nav><ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.goi_dich_vu.index') }}">Gói dịch vụ</a></li>
        <li class="breadcrumb-item active">Thêm mới</li>
    </ol></nav>
</div>

<form action="{{ route('admin.goi_dich_vu.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-8 d-flex flex-column gap-3">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3 d-flex align-items-center gap-2">
                    ...
                    <span class="fw-semibold">Thông tin gói dịch vụ</span>
                </div>
                <div class="card-body py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name"
                            ...
                            value="{{ old('name') }}"
                            placeholder="VD: Gói Massage Thư Giãn 60 Phút">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="number" name="price" id="priceInput"
                                ...
                                value="{{ old('price', 0) }}" min="0" step="1000" placeholder="0">
                        ...
                        <div class="mt-1" id="pricePreview" style="min-height:20px"></div>
                    </div>

                    <div class="p-3 rounded-3 d-flex align-items-center justify-content-between gap-3"
                        style="background:#f8fafc;border:1px solid #e2e8f0">
                        <div>
                            <div class="fw-semibold text-dark">Hiển thị gói dịch vụ</div>
                            <small class="text-muted">Bật để khách hàng nhìn thấy gói này trên website</small>
                        </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm sticky-top" style="top:80px">
                <div class="card-header bg-white border-bottom py-3 d-flex align-items-center gap-2">
                    ...
                    <span class="fw-semibold">Hình ảnh mẫu</span>
                </div>
                <div class="card-body">
                    ...
                    <div id="previewWrap" style="display:none;" class="mb-3">
                        <div class="position-relative">
                            <img id="previewImage" src="" alt="Preview"
                                class="w-100 rounded-3" style="object-fit:cover;max-height:200px;">
                    ...
                    <div id="uploadArea"
                        ...
                        <small class="text-muted" style="font-size:.72rem">Hỗ trợ JPG, PNG, WEBP — tối đa 5MB</small>
                    </div>
                ...
                <div class="card-footer bg-white border-top py-3 d-flex gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="bi bi-save me-1"></i>Lưu gói dịch vụ
                    </button>
                </div>
            </div>
        </div>
...
@push('scripts')
<script>
    // Định dạng giá realtime
    const priceInput   = document.getElementById('priceInput');
    const pricePreview = document.getElementById('pricePreview');
    function formatPrice() {
        const v = parseInt(priceInput.value) || 0;
        pricePreview.innerHTML = v > 0
            ? `<span class="text-primary fw-semibold"><i class="bi bi-arrow-right me-1"></i>${v.toLocaleString('vi-VN')} đồng</span>`
            : '';
    }
