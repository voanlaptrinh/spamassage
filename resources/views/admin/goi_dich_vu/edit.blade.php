...
<form action="{{ route('admin.goi_dich_vu.update', $item) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="card-body py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description"
                            ...
                            rows="4"
                            placeholder="Nhập mô tả chi tiết về gói dịch vụ này...">{{ old('description', $item->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback d-flex align-items-center gap-1">
                                <i class="bi bi-exclamation-circle-fill"></i> {{ $message }}
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="number" name="price" id="priceInput"
                                ...
                                value="{{ old('price', $item->price) }}" min="0" step="1000" placeholder="0">
