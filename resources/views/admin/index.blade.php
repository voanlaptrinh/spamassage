...
<head>
    ...
    <link rel="icon" type="image/png" sizes="144x144" href="{{ asset('/public/icons/android-chrome-144x144.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('/public/icons/android-chrome-192x192.png') }}">
    ...
    <meta property="og:image" content="{{ asset('/public/icons/512x512.png') }}">
